export const csMessages = {
    publicProfiles: {
        ...
        communityDescription:
            "Procházejte aktivní klany a jejich veřejné historie zápasů.",
    ...
    home: {
        ...
        signIn: "Přihlásit se přes Discord",
        contribute: "Přispět na GitHubu",
        loggedInAs: "Přihlášen jako {name}",
        dashboard: "Dashboard",
        community: "Prozkoumat komunitu",
        competitions: "Soutěže",
        featuresNav: "Funkce",
        liveOperations: "Operace propojené",
        commandCenter: "Velitelské centrum operací",
        commandCenterDescription:
            "Akce, soupisky, koordinace přes Discord a veřejná historie zápasů na jednom místě.",
        eventsMetric: "akcí",
        playersMetric: "hráčů",
        matchesMetric: "zápasů",
        nextOperation: "Další operace",
        registrationOpen: "Registrace otevřena",
        sampleOperation: "Sobotní kompetitivní zápas",
        sampleOperationMeta: "19:30 · 31 přihlášených",
        featuresEyebrow: "Pro organizované týmy",
        featureEventsDescription:
            "Naplánujte každý krok operace s jasnými časy a oznámeními připravenými pro Discord.",
        featureRostersDescription:
            "Sestavujte lineupy, koordinujte účast a udržte celý tým v obraze.",
        featureStats: "Veřejná historie zápasů",
        featureStatsDescription:
            "Sdílejte profily hráčů, výsledky a detailní analýzu zápasů s komunitou.",
        badge: "Discord operace pro organizované skupiny",
        title: "Logi udržuje komunitní operace přehledné, strukturované a na jednom místě.",
        description:
            "Logi je open-source platforma pro skupiny, které pořádají akce, spravují soupisky, tréninky, zápasy a koordinaci přes Discord.",
        featuresTitle: "Co skutečně umí",
        featuresDescription:
            "Plánujte akce, spravujte přihlášky, tvořte soupisky, připravujte zápasy a synchronizujte Discord.",
        featureEvents: "Akce, tréninky a workflow zápasů",
        featureRosters: "Správa soupisek a účasti",
        featureDiscord: "Správa serveru propojená s Discordem",
        featureTools: "Sdílené nástroje pro organizované komunity",
        commsBadge: "LogiComms",
        commsTitle: "Jasná komunikace jednotky bez zbytečné režie.",
        commsDescription:
            "LogiComms je lehká a rychlá desktopová aplikace pro efektivní komunikaci v jednotce. Nastavíte ji rychle a přizpůsobíte fungování své jednotky.",
        commsDownload: "Stáhnout pro Windows",
        commsUnavailable: "Stažení pro Windows je dočasně nedostupné.",
        freeToUse: "Zdarma k použití",
        ...
        pillars: {
            ...
            operationsDescription:
                "Plánování, přihlášky, organizace soupisek, příprava zápasů a Discord koordinace na jednom místě.",
            communitiesTitle: "Pro skutečné komunity",
            communitiesDescription:
                "Pro klany, jednotky a organizované skupiny, které potřebují strukturu bez zbytečné složitosti.",
            contributorsTitle: "Otevřené pro přispěvatele",
            contributorsDescription:
                "Open source, otevřené pull requesty a veřejné zlepšování s lidmi, kteří jej používají.",
        },
    },
    auth: {
        ...
        loginHint:
            "Přes Discord otevřete pracovní prostor svého klanu, soupisky i operační panel.",
        featureRostersTitle: "Soupisky",
        featureRostersBody:
            "Publikujte sestavy s volnými sloty, náhradníky a potvrzením účasti.",
        featureBriefingsTitle: "Briefingy",
        featureBriefingsBody:
            "Mějte taktické poznámky, mapy a přílohy po ruce u každé operace.",
        featureDiscordTitle: "Připraveno pro Discord",
        featureDiscordBody:
            "Nejprve se připraví webový panel, bot se integruje později.",
    ...
    dashboard: {
        title: "Vaše klany",
        description:
            "Vše, co spravujete, kde hrajete nebo s kým bojujete, najdete přehledně zde.",
        ...
        inviteBotHint:
            "Některé spravované klany ještě potřebují Discord bota, než je půjde tady plně otevřít.",
        inviteBotModalTitle: "Než pozvete bota",
        inviteBotModalDescription:
            "Dejte roli bota nad všechny Discord role, které má Logi přidávat nebo odebírat. Pokud bude role bota níž, Discord tyto změny zablokuje, i když má bot správná oprávnění.",
        inviteBotModalNotApplicable:
            "Tento klan teď nemá nastavené žádné Discord role, které by měl Logi přidávat nebo odebírat, takže se toto upozornění na pořadí rolí zatím nepoužije.",
    ...
    competition: {
        title: "Soutěže",
        description:
            "Oficiální informace o soutěžích a výsledky sledované v Logi.",
        back: "Zpět do Logi",
        standings: "Zobrazit tabulku a výsledky",
        ...
        noCompetitions: "Zatím nebyly vytvořeny žádné veřejné soutěže.",
        capScore: "Cap Score",
        regularWins: "Běžné výhry",
        totalWins: "Celkem výher",
        regularMatches: "Běžné zápasy",
    ...
    articles: {
        title: "Články",
        description: "Novinky klanu a delší aktualizace.",
        createTitle: "Vytvořit článek",
        createDescription: "Napište článek klanu v Markdownu.",
        create: "Vytvořit článek",
        noArticles: "Zatím nejsou žádné články.",
        titlePlaceholder: "Název",
        descriptionPlaceholder: "Krátký popis",
        tagsPlaceholder: "Štítky oddělené čárkou",
        bodyPlaceholder: "Obsah článku",
    ...
    userSettings: {
        ...
        platformIdHelp:
            "Sem vložte své Steam64 ID nebo Epic Account ID. Bez mezer.",
        platformIdSteamLink: "Steam návod",
        platformIdSteamHint:
            "Použijte oficiální návod od Valve a zkopírujte dlouhé číselné Steam64 ID.",
    ...
    serverSettings: {
        ...
        description:
            "Správa vzhledu klanu a nastavení práv pro správu operací.",
        pageDescription:
            "Upravte profil klanu, nastavení Discord automatizace a přístupová pravidla pro tento workspace.",
        frontendOnlyDescription: "Zatím pouze frontendová konfigurace klanu.",
        clanName: "Název klanu",
        discordTitle: "Nastavení Discord bota",
        discordDescription:
            "Spravujte kanály, role, časové pásmo a chování přihlašování skupin pro Discord bota.",
        ...
        playerStatsServersDescription:
            "Přidejte jedno nebo více připojení ke stats API. Vyhledávání hráčů bude dotazovat všechny nastavené servery.",
        ...
        rosterScoreDescription:
            "Nastavte, jak se hráčům změní skóre po uzavření reakcí na akci.",
        ...
        botRequiredNotice:
            "Bot už musí být na serveru, aby se plný workspace zpřístupnil.",
        accessModel: "Model přístupu",
        accessAdmins:
            "Admini: plný přístup k akcím, šablonám, soupiskám a nastavení klanu.",
        accessMembers:
            "Členové a žoldáci: vidí pouze kalendář a publikované soupisky.",
        accessBackend:
    ...
    ticketSettings: {
        ...
        enableDescription:
            "Zveřejní konfigurovatelný ticket panel na Discordu a bude otevírat soukromé ticket thready z jeho kategorií.",
        ...
        categoriesDescription:
            "Každá kategorie se stane tlačítkem a volitelně může nejdřív otevřít Discord modal, než se vytvoří ticket thread.",
        ...
        modalQuestionsDescription:
            "Discord podporuje až 5 textových vstupů v jednom modalu.",
    ...
    membershipSettings: {
        ...
        enableDescription:
            "Zveřejní klanový application embed na Discordu a z něj bude otevírat soukromé thready spravované staffem.",
        ...
        modalQuestionsDescription:
            "Až 5 textových vstupů, stejně jako u ticket modal flow.",
        noQuestions:
    ...
    userManagement: {
        ...
        platformAlreadyLinked:
            "Toto platform ID už je propojené s jiným hráčem.",
        paused: "Pozastaveno",
        active: "Aktivní",
        ...
        autoLinkPlatformIdsDescription:
            "Projde importované scoreboardy akcí, odebere clan tag ze jmen hráčů a automaticky doplní odpovídající platform ID.",
        autoLinkPlatformIdsHint:
            "Zadejte clan tag přesně tak, jak se objevuje před jmény hráčů v importovaných akcích. Příklad: VLKㆍ",
        autoLinkPlatformIdsSuccess:
            "Propojeno {linked} platform ID z {players} nalezených hráčských záznamů.",
        autoLinkPlatformIdsPartial:
            "Část výsledků byla přeskočena: {ambiguous} nejednoznačných, {conflicts} konfliktů, {failed} selhaných akcí.",
        dedupePlayerStats: "Vyčistit duplicity statistik",
        dedupePlayerStatsDescription:
            "Odstraní duplicitní importované řádky zápasů pro akce tohoto klanu a pokud to jde, ponechá lepší kopii místo varianty Unknown.",
        dedupePlayerStatsHint:
            "Toto čistí jen importované player stats pro akce tohoto klanu. Zápasy jiných klanů tím neovlivníte.",
        dedupePlayerStatsSuccess:
            "Odstraněno {matches} duplicitních řádků zápasů napříč {users} hráči.",
        refreshPerformanceHistory: "Obnovit statistiky klanu a hráčů",
        refreshPerformanceHistorySuccess:
            "Statistiky klanu a hráčů byly obnoveny.",
        refreshPerformanceHistoryError:
            "Statistiky klanu a hráčů se nepodařilo obnovit.",
        mergeUsers: "Sloučit účty",
        mergeUsersDescription:
            "Úplně sloučí dva účty. Primární účet má přednost všude tam, kde se data obou účtů překrývají.",
        ...
        mergeUsersHint:
            "Přepíše player stats, importované zápasy, přiřazení, soupisky a vložené odkazy v akcích na primární účet.",
        ...
        importDiscordMembersDescription:
            "Naimportujte všechny, kdo mají vybranou Discord roli, do správy hráčů.",
        importDiscordMembersHint:
            "Importovaní hráči nedostanou hlavní skupinu. Odpovídající Discord role skupin se přidají jako vedlejší skupiny.",
        membershipMigration: "Migrovat členství podle role",
        membershipMigrationDescription:
            "Vyberte Discord roli a cílový stav členství, na který se mají převést existující přiřazení v tomto klanu.",
        membershipMigrationTarget: "Cílový stav členství",
        membershipMigrationHint:
            "Aktualizují se jen hráči, kteří už mají v tomto klanu přiřazení. Nepřiřazení Discord členové se přeskočí.",
        membershipMigrationSuccess:
            "Aktualizováno {updated} hráčů na stav {status}.",
        membershipMigrationSkippedUnassigned:
            "Přeskočeno {count} Discord členů bez klanového přiřazení.",
        membershipMigrationSkippedUnchanged:
            "Přeskočeno {count} hráčů, kteří už tento stav měli.",
        discordSourceRole: "Zdrojová Discord role",
        discordImportSuccess:
            "Naimportováno {players} hráčů z {matched} odpovídajících Discord členů.",
        discordImportSkipped:
            "{count} odpovídajících Discord členů bylo přeskočeno, protože je nebylo možné importovat s vybraným typem zařazení.",
        ...
        pickPlayerFirst:
            "Nejprve vyberte hráče ze seznamu vyhledávání v systému.",
        ...
        assignmentMetaDescription:
            "Úprava klanového členství, role žoldáka, skupiny a stavu pozastavení.",
        ...
        removePlayerConfirm:
            "Odebrat tohoto hráče z klanu? Tímto smažete jeho přiřazení.",
        ...
        missingMembershipCategoryTitle:
            "Toto přiřazení není propojené s membership kategorií",
        missingMembershipCategoryDescription:
            "Recruit a finální role kategorie nejdou u ručních přiřazení synchronizovat bez propojené kategorie z membership přihlášky. Na Discordu se tak mohou aplikovat jen klanová role a role navázané na skupiny.",
        missingCategoryRolesTitle: "Role membership kategorie nejsou kompletní",
        missingRecruitRoleDescription:
            "Tato kategorie nemá nastavenou recruit roli. ",
        missingFinalRoleDescription:
            "Tato kategorie nemá nastavenou finální roli. ",
        missingCategoryRolesSummary:
            "Logi bude membership status držet tady, ale odpovídající Discord role se pro tuto fázi nepřidá.",
        linkMissingDiscordIds: "Doplnit chybějící Discord ID",
        linkMissingDiscordIdsDescription:
            "Spárujte importované hráče bez Discord ID s členy z vybrané Discord role.",
        linkMissingDiscordIdsHint:
            "Jména se před porovnáním normalizují a propojí se první odpovídající Discord člen.",
    ...
    calendarCards: {
        ...
        noEvents:
            "Pro vybrané datum nejsou v této ukázce naplánovány žádné akce.",
    },
    roster: {
        title: "Soupiska",
        listDescription:
        ...
        deleteRosterDescription:
            "Tímto se tato nepublikovaná soupiska trvale smaže. Publikovanou soupisku je nutné nejdříve znepublikovat.",
        deleted: "Soupiska smazána",
        changeSquadTemplateTitle: "Změnit šablonu jednotek?",
        changeSquadTemplateDescription:
            "Tím se nahradí rozložení jednotek a resetují všechna ruční přiřazení hráčů. Aktuálně přiřazení hráči se přesunou zpět do záloh.",
        ...
        selectEventAndPresetToStart:
            "Vyberte událost a šablonu jednotek pro zahájení draftování soupisky",
        ...
        unsignedPlayerConfirmDescription:
            "{name} se na tuto akci nepřihlásil. Opravdu ho chcete přidat do soupisky?",
        unsignedPlayerConfirmAction: "Přidat do soupisky",
        autoFill: "Automaticky doplnit soupisku",
        autoFillDescription:
            "Hráči se zpracují od nejsilnějších a pak se přiřadí do nejbližší možné jednotky podle přihlášení, primární skupiny a sekundárních skupin.",
        ...
        confirmFromMeetingChannelHelp:
            "Pro zapnutí této akce nastavte v nastavení klanu hlasový kanál pro sraz.",
        confirmingFromMeetingChannel: "Potvrzuji ze srazového VC...",
        confirmedFromMeetingChannel:
            "Potvrzeno {count} hráčů ze soupisky podle srazového VC.",
        noRosterPlayersInMeetingChannel:
            "Ve srazovém VC nebyli nalezeni žádní hráči ze soupisky.",
        noNewMeetingChannelAttendanceChanges:
            "Hráči ze soupisky byli ve srazovém VC nalezeni, ale nebylo potřeba provést žádné nové změny docházky.",
    ...
    event: {
        ...
        showRoster: "Zobrazit soupisku",
        rosterPublishedHint:
            "Tato akce má publikovanou soupisku. V případě potřeby ji odsud otevřete.",
        rosterDraftHint:
            "Soupiska je přiřazena, ale pro běžné členy je stále skrytá.",
        rosterMissingHint:
        ...
        topicThreadResyncQueued:
            "Synchronizace vláken témat byla zařazena do fronty.",
        generalSignupDescription:
            "Zapne jedno obecné tlačítko pro přihlášení, které hráče zařadí do jejich primární skupiny, pokud je pro tento zápas povolená, jinak do rezerv.",
        signupGroupsDescription:
            "Vyberte, která tlačítka konkrétních skupin se mají pro tento zápas zobrazit.",
        ...
        importEventsSuccess:
            "Naimportováno {events} akcí a {players} záznamů hráčů.",
        ...
        matchResultsImported:
            "Naimportováno {players} záznamů hráčů. Výsledek akce: {result}.",
        resultSaved: "uložen",
        ...
        matchDetailDescription:
            "Raw importovaný scoreboard, výkony hráčů a rozpad statistik týmů pro tuto akci.",
        rawSource: "Zdroj",
        ...
        noMatchLinked:
            "K této akci zatím není přiřazen žádný importovaný zápas.",
        alliedTeam: "Allies",
        axisTeam: "Axis",
        teamUnknown: "Neznámý",
        ...
        encountersDescription:
            "Odvozeno z importovaných agregovaných statistik hráčů jako most killed a death by.",
        ...
        trainingCompletionDescription:
            "Před ukončením trainingu nastavte u každého zúčastněného, jestli prošel nebo neprošel.",
        trainingCompletionEmpty:
            "Na tento training momentálně není přihlášený žádný účastník s attendance.",
        trainingCompletionSuccess:
            "Training byl ukončen. Odměněno: {rewarded}. DM odesláno: {dmed}.",
        ...
        notices: {
            ...
            announcementsDescription:
                "Discord event announcement zprávy se nebudou zveřejňovat ani aktualizovat, dokud se pro tento klan nenastaví kanál pro oznámení.",
            forumTitle: "Forum kategorie není nastavená",
            forumDescription:
                "Tato akce má vytvářet Discord forum kanál, ale forum kategorie není nastavená. Forum kanál i briefingová témata se budou přeskakovat, dokud se to nenastaví.",
            meetingAutomationTitle: "Automatizace meeting voice je vypnutá",
            meetingAutomationDescription:
                "Discord scheduled events i potvrzování attendance ze meeting VC závisí na nastavení klanového meeting voice kanálu.",
        ...
        channelRoutingSharedHelp:
            "Vyberte kanál registrace. Pokud informační kanál akce necháte prázdný, kanál registrace se použije pro obě zprávy.",
        channelRoutingLockedHelp:
            "Směrování je po vytvoření uzamčené, aby ID Discord zpráv zůstala stabilní.",
        ...
        quickScheduleDescription:
            "Nastavte čtyři hlavní časy zápasu. Vygenerovanou časovou osu můžete kdykoli upravit.",
        ...
        recurringMatch: "Vytvořit opakovaný zápas",
        recurringMatches: "Opakované zápasy",
        recurringMatchesDescription:
            "Spravujte série zápasů, které se opakují podle rozvrhu.",
        noRecurringMatches: "Zatím nebyly vytvořeny žádné opakované zápasy.",
        recurrenceHelp:
            "Právě vytvářený zápas je první v této sérii. Jeho údaje a čas se použijí pro budoucí výskyty.",
        recurrenceFrequency: "Opakování",
        recurrenceWeekly: "Týdně",
        recurrenceMonthlyDate: "Měsíčně v daný den",
        recurrenceMonthlyNthWeekday: "Měsíčně v daný den týdne",
        recurrenceInterval: "Každý interval",
        recurrenceWeekdays: "Dny v týdnu",
        recurrenceMonthDay: "Den v měsíci",
        recurrenceNth: "Týden v měsíci",
        recurrenceWeekday: "Den v týdnu",
    ...
    presets: {
        ...
        createTopicDescription:
            "Vytvářejte a upravujte strukturu témat na jednom místě.",
        createSquadTitle: "Vytvořit šablonu jednotek",
        createSquadDescription:
            "Vytvářejte a upravujte strukturu šablon na jednom místě.",
        presetDetails: "Detaily šablony",
        presetCreateMode: "Režim vytvoření začíná přímo v režimu úprav.",
        squadPresetPageDescription:
            "Přednastavené jednotky a role, které lze zkopírovat do soupisek akcí.",
        squadPresetMetaDescription:
            "Přednastavená struktura jednotek pro nové soupisky.",
        topicPresetMetaDescription:
            "Znovupoužitelné šablony briefingů zkopírované do akcí v případě potřeby.",
        topics: "Témata",
        ...
        topicPresetPageDescription:
            "Stejná struktura jako u akcí, ale zaměřená na znovupoužitelný obsah briefingu.",
    ...
    groups: {
        ...
        createDescription:
            "Vytvořte znovupoužitelnou klanovou specializaci s barvou a krátkým popisem.",
        name: "Název skupiny",
        color: "Barva",
        ...
        resetConfirm:
            "Tímto smažete skupiny, šablony jednotek a šablony témat pro tento klan. Akce, soupisky a hráči zůstanou. Pokračovat?",
        initializeConfirm:
    ...
    clan: {
        ...
        performanceComparedWithPrevious:
            "{change} {metric} oproti předchozím {count}",
        performanceNoData:
            "Zatím nejsou k dispozici žádná zaznamenaná data. Zobrazí se po dalším importu nebo obnovení statistik.",
        combat: "Bojový výkon",
        ...
        topPlayersCalculation:
            "Hráči jsou seřazeni podle celkového počtu zabití za posledních 10 zápasů. Při shodě rozhoduje počet odehraných zápasů; K/D, útok, obrana a podpora se nezapočítávají.",
        ...
        systemTitle: "Systém",
        systemBody: "API klíče klanu a nástroje údržby.",
        websiteApi: "Webové API",
        ...
        webhookUi: {
            ...
            enabled: "Aktivní",
            disabled: "Neaktivní",
            eventTypes: "typů událostí",
            lastDelivery: "Poslední doručení",
            lastFailure: "Poslední chyba",
            never: "nikdy",
            enable: "Aktivovat",
            disable: "Deaktivovat",
            sendTest: "Odeslat test",
            rotate: "Obnovit tajemství",
            history: "Historie",
            delete: "Smazat",
            historyTitle: "Historie doručení",
            noHistory: "Zatím žádná doručení.",
            status: "Stav",
            attempt: "Pokus",
            response: "Odpověď",
            created: "Vytvořeno",
    ...
    stratmaps: {
        ...
        detailDescription:
            "Realtime spolupráce nad taktickou mapou pro plánování zápasu.",
        ...
        createSlideDescription:
            "Zadejte název slidu a volitelně nahrajte vlastní obrázek na pozadí.",
        ...
        customBackgroundHint:
            "Když nic nenahrajete, slide použije mapu jako pozadí.",
        ...
        selectedElementHint:
            "Pomocí nástroje pro výběr můžete s prvkem hýbat. Poznámky a obrázky se zobrazují jen u vybrané ikony.",
        grid: "Mřížka",
