...
export default async function CommunityPage({ params, searchParams }: Props) {
  ...
  return <PublicSiteShell locale={resolvedLocale}><PublicPage><div className="space-y-10">
    <PublicBreadcrumbs items={[{ label: dictionary.app.name, href: `/${resolvedLocale}` }, { label: dictionary.publicProfiles.communityTitle }]} />
