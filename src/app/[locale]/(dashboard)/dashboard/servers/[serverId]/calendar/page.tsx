...
export default async function ServerCalendarPage({
  ...
  const { events, rosters, discordConfig, server } = context;
  ...
  return (
    <>
      ...
      <div className="px-4 lg:px-6">
        <CalendarView locale={locale as "en"} serverId={serverId} events={events} eventCategories={server.eventCategories ?? []} rosters={rosters} timezone={discordConfig?.timezone} dictionary={dictionary} />
      </div>
    </>
  );
}
