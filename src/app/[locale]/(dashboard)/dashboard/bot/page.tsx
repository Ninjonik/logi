...
export default async function BotDashboardPage({
    ...
    const level =
        typeof query.level === "string"
            ? (query.level as SystemLogLevel)
            : undefined
    const source =
        typeof query.source === "string"
            ? (query.source as SystemLogSource)
            : undefined
            ...
            <div className="flex h-full min-h-0 flex-col gap-6">
                ...
                <div className="grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)]">
                    <Card className="border-border/60 rounded-2xl">
                        <CardHeader>
                            <CardTitle>
                                {dictionary.dashboard.filtersTitle}
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <form className="space-y-4" method="get">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="level">
                                        {dictionary.dashboard.filterLevel}
                                    </Label>
                                    <select
                                        id="level"
                                        name="level"
                                        defaultValue={level ?? ""}
                                        className="border-input flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm"
                                    >
                                        <option value="">
                                            {dictionary.dashboard.allLevels}
                                        </option>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="source">
                                        {dictionary.dashboard.filterSource}
                                    </Label>
                                    <select
                                        id="source"
                                        name="source"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="scope">
                                        {dictionary.dashboard.filterScope}
                                    </Label>
                                    <select
                                        id="scope"
                                        name="scope"
                                    ...
                                    >
                                        <option value="">
                                            {dictionary.dashboard.allScopes}
                                        </option>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    >
                                        {dictionary.dashboard.applyFilters}
                                    </Button>
                                    <Button
                                        asChild
                                        type="button"
                            ...
                            <div className="border-border/60 space-y-3 rounded-xl border p-4">
                                ...
                                <div className="text-muted-foreground space-y-2 text-sm">
                                    {stats.topScopes.length ? (
                                        stats.topScopes.map((entry) => (
                                            <div
                                                key={entry.scope}
                    ...
                    <ResourceTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                render: (row) => (
                                    <code className="text-muted-foreground block max-w-[420px] overflow-hidden text-xs text-ellipsis whitespace-pre-wrap">
                                        {JSON.stringify(
                                            row.context ?? {},
                                            null,
                                            0
