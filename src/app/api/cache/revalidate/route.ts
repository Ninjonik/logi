    ...
    switch (payload.type) {
        case "assignment-changed":
            return [
                ...
                payload.assignmentId
                    ? appCacheTags.assignment(payload.assignmentId)
                    : undefined,
        ...
        case "roster-changed":
            return [
                ...
                appCacheTags.rosterImage(),
                payload.eventId
                    ? appCacheTags.rosterImageEvent(payload.eventId)
                    : undefined,
            ]
        case "event-changed":
            return [
...
function parsePayload(body: unknown): CacheRevalidationPayload | null {
    ...
    if (
        ...
        !isNonEmptyString(payload.serverId)
    ) {
        return null
    }
    ...
    switch (payload.type) {
        case "assignment-changed":
            ...
            return {
                ...
                assignmentId: isNonEmptyString(payload.assignmentId)
                    ? payload.assignmentId
                    : undefined,
            }
        case "roster-changed":
            ...
            return {
                ...
                eventId: isNonEmptyString(payload.eventId)
                    ? payload.eventId
                    : undefined,
            }
        case "event-changed":
