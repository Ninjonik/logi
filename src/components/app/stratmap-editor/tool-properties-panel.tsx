    ...
    <Card className="rounded-xl border-border/60">
      ...
      <CardContent className="space-y-3 px-3 pb-3">
        ...
        {tool === "line" || tool === "measure" ? (
          <>
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1.5"><Label className="text-xs">{dictionary.stratmaps.lineStart}</Label><ArrowStyleSelect value={lineStartStyle} onChange={onLineStartStyleChange} dictionary={dictionary} /></div>
              <div className="space-y-1.5"><Label className="text-xs">{dictionary.stratmaps.lineEnd}</Label><ArrowStyleSelect value={lineEndStyle} onChange={onLineEndStyleChange} dictionary={dictionary} /></div>
            </div>
