...
export function PlayerAdminAccessButton({
    ...
    function updateAdminAccess(nextIsAdmin: boolean) {
        startTransition(async () => {
            try {
                ...
                toast.success(
                    nextIsAdmin
                        ? dictionary.userManagement.adminAccessGranted
                        : dictionary.userManagement.adminAccessRemoved
                )
            } catch {
    ...
    return (
        ...
        >
            ...
            {isAdmin
                ? dictionary.userManagement.removeAdminAccess
                : dictionary.userManagement.grantAdminAccess}
        </Button>
    )
}
