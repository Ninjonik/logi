        ...
        startTransition(async () => {
            ...
            toast.success(
                dictionary.userManagement.dedupePlayerStatsSuccess
                    .replace(
                        "{matches}",
                        String(body.duplicateMatchesRemoved ?? 0)
                    )
                    .replace(
                        "{users}",
                        String(body.affectedUserIds?.length ?? 0)
                    )
            )
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="rounded-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {dictionary.userManagement.dedupePlayerStatsDescription}
                    </DialogDescription>
                </DialogHeader>
                <p className="text-muted-foreground text-sm">
                    {dictionary.userManagement.dedupePlayerStatsHint}
                </p>
                <DialogFooter>
                    <Button
                        type="button"
