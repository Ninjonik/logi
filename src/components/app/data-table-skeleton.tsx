...
export function DataTableSkeleton({
    ...
    return (
        <div className="border-border/60 bg-card flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border">
            ...
            <div className="min-h-0 flex-1 overflow-auto">
                <div className="min-w-full">
                    <div
                        className="bg-card sticky top-0 z-10 grid border-b px-4 py-3"
                        style={{
