...
const compactMarkdownExtraCommands: NonNullable<
    MDEditorProps["extraCommands"]
...
export function DiscordMarkdownTextarea({
    ...
    return (
        <div
            className={cn(
                "border-input overflow-hidden rounded-xl border bg-transparent shadow-xs transition-[color,box-shadow]",
        ...
        >
            <MDEditor
                ...
                extraCommands={
                    compactToolbar ? compactMarkdownExtraCommands : undefined
                }
