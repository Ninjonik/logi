...
export class InMemoryEventRepository<
    TEvent extends EventLike & { id: string; guildId?: string },
...
export class InMemoryRosterRepository<
    TRoster extends RosterLike & { eventId: string },
> implements RosterRepository<TRoster> {
