...
const clanDiscordMessages: Record<ClanLanguage, ClanDiscordMessages> = {
  en: {
    ...
    platformFlow: {
      ...
      playedBeforeYes: "Yes",
      playedBeforeYesDescription: "Search for your name from the configured stats servers.",
      playedBeforeNo: "No",
      playedBeforeNoDescription: "Choose your platform and enter your platform ID manually.",
      playerSearchIntro: "Search for your player, then pick the matching entry from the returned results.",
      ...
      playerSearchEmptyOption: "No players loaded yet",
      playerSearchEmptyDescription: "Click Search player to load matches",
    ...
    platformFlowCsFallback: {
      ...
      membershipIntro: "Ne? budeme pokra?ovat s va?? klanovou p?ihl??kou, mus?te si tady v Discordu propojit platform ID.",
      linkIntro: "Propojte si platform ID p??mo tady v Discordu. U? nen? pot?eba web ani DM odkaz.",
      startButton: "Propojit platform ID",
      addAnotherButton: "P?idat dal?? platform ID",
      unlinkButton: "Odpojit platform ID",
      manageDescription: "N??e m??ete spravovat sv? propojen? platform ID.",
      linkedFieldTitle: "Propojen? platform ID",
      playedBeforePrompt: "Hr?l(a) jste u? d??ve na serveru tohoto klanu?",
      playedBeforePlaceholder: "Vyberte jednu mo?nost",
      playedBeforeYes: "Ano",
      playedBeforeYesDescription: "Vyberete sv? jm?no z do?asn? mockovan?ho seznamu.",
      playedBeforeNo: "Ne",
      playedBeforeNoDescription: "Vyberete platformu a zad?te platform ID ru?n?.",
      playerSearchIntro: "Vyberte z?znam hr??e, kter? v?m odpov?d?. Zat?m je to mock, ne? bude hotov? API vyhled?v?n?.",
      playerSearchPlaceholder: "Vyberte jm?no hr??e",
      playerSearchNoMatches: "Nebyli nalezeni ??dn? odpov?daj?c? hr??i. Ponech?v?m aktu?ln? mo?nosti.",
      playerSearchButton: "Hledat hr??e",
      playerSearchModalTitle: "Hledat hr??e",
      playerSearchModalLabel: "Jm?no hr??e nebo k?d",
      playerSearchModalPlaceholder: "Napi?te ??st jm?na nebo player ID",
      platformIntro: "Vyberte platformu. Uk??u stejn? n?vod jako v dne?n?m webov?m flow a pak zad?te platform ID.",
      platformPlaceholder: "Vyberte platformu",
      platformSteam: "Steam",
      platformEpic: "Epic Games",
      platformXbox: "Xbox",
      platformPlaystation: "PlayStation",
      guideLinkLabel: "N?vod",
      submitIdButton: "Zadat platform ID",
      continueWithIdButton: "Zadat platform ID a pokra?ovat",
      linkedSuccess: "Va?e platform ID bylo ?sp??n? propojeno.",
      linkedAndContinuing: "Va?e platform ID bylo propojeno. Pokra?uji s klanovou p?ihl??kou.",
      mockLinkedSuccess: "Va?e platform ID bylo ?sp??n? mockovan? propojeno.",
      invalidPlatformId: "Zadejte platform ID bez mezer.",
      unlinkPrompt: "Vyberte platform ID, kter? chcete odpojit.",
      unlinkPlaceholder: "Vyberte platform ID k odpojen?",
      invalidAction: "Tato akce propojen? platform ID u? nen? platn?.",
      invalidModal: "Tento modal pro propojen? platform ID u? nen? platn?.",
      invalidSearchModal: "Tento modal pro hled?n? hr??e u? nen? platn?.",
      guides: {
        steam: {
          label: "Steam64 ID",
          help: "Pot?ebujete dlouh? ??seln? Steam64 ID sv?ho ??tu.",
          stepOne: "Otev?ete n?vod.",
          stepTwo: "Najd?te zobrazen? Steam64 ID.",
          stepThree: "Zkop?rujte toto dlouh? ??slo do dal??ho kroku.",
        },
        epic: {
          label: "Epic Account ID",
          help: "Pot?ebujete sv? Epic Account ID.",
          stepOne: "Otev?ete n?vod.",
          stepTwo: "Otev?ete detaily sv?ho Epic ??tu.",
          stepThree: "Zkop?rujte Account ID do dal??ho kroku.",
        },
        xbox: {
          label: "Xbox ID",
          help: "Pou?ijte stejn? postup jako v aktu?ln?m flow pro Xbox.",
          stepOne: "Otev?ete n?vod.",
          stepTwo: "Potvr?te spr?vn? identifik?tor Xbox profilu.",
          stepThree: "Vlo?te tento identifik?tor do dal??ho kroku.",
        },
        playstation: {
          label: "PlayStation ID",
          help: "Pou?ijte stejn? postup jako v aktu?ln?m flow pro PlayStation.",
          stepOne: "Otev?ete n?vod.",
          stepTwo: "Potvr?te spr?vn? identifik?tor PlayStation profilu.",
          stepThree: "Vlo?te tento identifik?tor do dal??ho kroku.",
        },
      },
    },
