...
const clanDiscordMessages: Record<ClanLanguage, ClanDiscordMessages> = {
  en: {
    ...
    interaction: {
      ...
      changeSignupSelection: "You are already signed up. Use the selector below only to change your role; choosing the same role keeps your signup.",
  ...
  cs: {
    ...
    interaction: {
      ...
      changeSignupSelection: "Už jste přihlášeni. Výběr níže použijte jen pro změnu role;",
