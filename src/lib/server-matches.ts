...
const upsertMatchForEventReference = makeFunctionReference<"mutation">(
    "matchStats:upsertForEvent"
)
const getMatchByEventIdReference = makeFunctionReference<"query">(
    "matchStats:getByEventId"
)
const findMatchByIdentityReference = makeFunctionReference<"query">(
    "matchStats:findByIdentity"
)
