...
const importDiscordMembersReference = makeFunctionReference<"mutation">(
    "userAssignments:importDiscordMembers"
)
const removeAssignmentReference = makeFunctionReference<"mutation">(
    "userAssignments:remove"
)
const reassignImportedMemberReference = makeFunctionReference<"mutation">(
    "userAssignments:reassignImportedMember"
)
const updatePlatformIdsReference = makeFunctionReference<"mutation">(
    "players:updatePlatformIds"
)
const clearPlatformIdsReference = makeFunctionReference<"mutation">(
    "players:clearPlatformIds"
)
const updatePlayerNoteReference =
    makeFunctionReference<"mutation">("players:updateNote")
const upsertImportedProfileReference = makeFunctionReference<"mutation">(
    "players:upsertImportedProfile"
)
const linkImportedDiscordProfileReference = makeFunctionReference<"mutation">(
    "players:linkImportedDiscordProfile"
)
const mergeUsersReference =
