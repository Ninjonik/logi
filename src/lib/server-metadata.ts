...
const getGuildByDiscordIdReference = makeFunctionReference<"query">(
    "guilds:getByDiscordId"
)
...
const getRosterByIdReference = makeFunctionReference<"query">(
    "serverMetadata:getRosterById"
)
const getSquadPresetByIdReference = makeFunctionReference<"query">(
    "serverMetadata:getSquadPresetById"
)
const getTopicPresetByIdReference = makeFunctionReference<"query">(
    "serverMetadata:getTopicPresetById"
)
...
const getMatchByEventIdReference = makeFunctionReference<"query">(
    "matchStats:getByEventId"
)
